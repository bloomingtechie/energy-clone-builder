    ...
    <section className="py-16 md:py-24">
      <div className="section-container max-w-4xl mx-auto">
        ...
        <p className="text-muted-foreground mb-6">
          In collaboration with our development partners we are developing a
          clean energy fund with a mission to confront climate change by
          accelerating the flow of private capital in domestic currency into
          energy projects and climate-smart technologies that facilitate
          Nigeria's energy transition towards clean energy sources and energy
          efficiency that reduce carbon emissions and achieve less expensive,
          more reliable sources of energy while creating jobs and supporting
          local economic growth.
        </p>
        <p className="text-muted-foreground mb-6">
          A local currency fund dedicated to clean energy projects will act as a
          catalyst for private sector participation in climate and sustainable
          infrastructure finance by attracting investments from pension funds,
          insurance firms and other long-term institutional investors into
          eligible climate change adaptation projects linked to National
          Determined Contributions (NDCs), deepening the local capital markets
          with a new climate-compliant infrastructure asset and facilitating
          access to long term local currency.
        </p>
        <p className="text-muted-foreground">
          Our aim is to mobilise blended finance to attract private investments
          that will support the country in delivering a more ambitious Paris
          aligned NDCs.
        </p>
      </div>
    </section>
      ...
      <div className="section-container max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 my-10">
          ...
          <div className="bg-background rounded-xl p-6 text-center shadow-sm">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Spent on fossil fuel generators yearly
            </p>
          </div>
        </div>

        <p className="text-muted-foreground mb-6">
          Nigeria is currently the largest economy in Sub-Saharan Africa (GDP of
          $405 billion) with a population of about 184 million people. The
          electricity demand (industrial and domestic) is estimated to be about
          180,000 Mega Watts (MW). The country however only has an installed
          capacity of 11,000MW, 8,000MW of which is operational.
        </p>
        <p className="text-muted-foreground">
          The development of off-grid alternatives such as mini-grids and solar
          systems, used efficiently, would create a $9.2 billion market
          opportunity and would potentially help Nigeria save c.$4.4 billion per
          annum, in addition to reducing carbon emissions and environmental
          degradation.
        </p>
      </div>
    </section>
      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {values.map((v) => (
            <div
              key={v.title}
              className="bg-muted rounded-xl p-8 flex items-start gap-5"
            >
    ...
    <section className="py-16 md:py-20 cef-gradient-bg">
      <div className="section-container max-w-4xl mx-auto text-center">
        ...
        <p className="text-primary-foreground/80">
          FundCo Capital Managers is authorised and registered by the Nigeria
          Securities & Exchange Commission to act as fund manager for the Clean
          Energy Local Currency Fund. Renaissance Securities (Nigeria) Limited
          is acting as the Issuing Housing and Financial Adviser to the Fund.
        </p>
      </div>
    </section>
  </div>
