...
const fundAims = [
  ...
  {
    icon: DollarSign,
    text: "Reduce FX exposure by providing local currency financing",
  },
  {
    icon: BarChart3,
    text: "Create a diversified portfolio of investments across multiple value chains",
  },
];
  ...
  <div>
    ...
    >
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, hsla(210,70%,20%,0.8), hsla(175,70%,30%,0.5))",
        }}
      />
      <div className="section-container relative z-10 flex flex-col lg:flex-row items-center gap-10 py-20">
        <div className="flex-1">
          ...
          <a
            href="#about"
            className="inline-flex items-center gap-2 text-primary-foreground border border-primary-foreground/40 rounded-full px-5 py-2 hover:bg-primary-foreground/10 transition-colors"
          >
    ...
    <section id="about" className="py-16 md:py-24 bg-muted">
      <div className="section-container text-center max-w-3xl mx-auto">
        <h2 className="text-xl md:text-2xl font-heading font-semibold text-foreground">
          We provide local currency funding from domestic institutional
          investors to small and medium sized climate compliant energy projects.
        </h2>
      </div>
    </section>
    ...
    <section className="py-16 md:py-20">
      <div className="section-container">
        <p className="text-center text-muted-foreground font-medium mb-10 uppercase tracking-wider text-sm">
          Our investment will directly address key priority sectors
        </p>
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
          {sectors.map((s) => (
            <div
              key={s.label}
              className="flex flex-col items-center gap-3 p-6 rounded-xl bg-muted hover:shadow-lg transition-shadow"
            >
    ...
    <section className="py-16 md:py-20 cef-gradient-bg">
      <div className="section-container">
        <h3 className="text-center font-heading font-bold text-lg uppercase tracking-wider text-primary-foreground mb-4">
          The Fund Aims To
        </h3>
        <p className="text-center text-primary-foreground/80 mb-12 max-w-2xl mx-auto">
          Provide domestic capital to support climate mitigation and energy
          transition projects
        </p>
    ...
    <section className="py-16 md:py-24">
      <div className="section-container">
        <p className="text-sm font-heading uppercase tracking-wider text-secondary mb-2">
          Eligibility Criteria
        </p>
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground mb-4">
              Got a project? Check our eligibility criteria on how we choose
              where to invest.
            </h2>
            <p className="text-muted-foreground mb-6">
              ...
              structure around it that reflects the risks and particularities of
              that investment.
            </p>
            <a
              href={factsheetPdf}
      ...
      <div className="section-container grid md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <p className="text-muted-foreground mb-6">
            ...
            scale fund rating with the outlook accorded as Stable.
          </p>
