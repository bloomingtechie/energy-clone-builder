    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur shadow-sm">
      <div className="section-container flex items-center justify-between h-16 md:h-20">
        <Link to="/" className="flex-shrink-0">
          <img src={logo} alt="Clean Energy Local Currency Fund" className="h-10 md:h-14 w-auto" />
        </Link>
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <a href="mailto:info@cleanenergyfund.ng" className="text-primary hover:text-secondary transition-colors">
            <Mail size={18} />
          </a>
        </div>
